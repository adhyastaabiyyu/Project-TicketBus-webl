    ...
    <section>
        ...
        <article>
            ...
            <div class="menu_psn">
                        ...
                        <div class="psn_tiket">
                            <input type="submit" name="submit" value="Tambah Rute">
                        </div>
                    </div>
                </form>
                ...
                <?php 
                    if (isset($_POST['submit'])) {
                        ...
                        $insert = mysqli_query($conn, "INSERT INTO tiket VALUES (
                            null,
                            '".$nama_penumpang."',
                            '".$nama."',
                            '".$awal."',
