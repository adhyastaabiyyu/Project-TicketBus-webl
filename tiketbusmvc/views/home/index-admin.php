...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/style-indexadminmvc.css">
</head>
...
<body>
    ...
    <section>
        <br>
        <div class="pesan">
            <a href="/tiketbusmvc/views/rute-admin.php/">
        ...
        <article>
            <div class="header-indxadmin">
                <h2> ELECTRIC BUS </h2>
            </div>
            <div>
                <nav class="menu-indxadmin">
                    <ul>
            ...
            <div class="content-admin">
                <p class='sambutan'>Selamat Datang </p>
            </div>
            <div>
                <img class='gambar1'src="../../public/img/terminal-joyoboyo.jpg" alt="">
            </div>
            <div>
                <img class='gambar2'src="../../public/img/bis-surabaya.jpg" alt="">
            </div>
            <div>
                <img class='gambar3'src="../../public/img/sby-bis.jpg" alt="">
            </div>
            <div>
                <img class='gambar4'src="../../public/img/logo-golekbus.png" alt="">
            </div>
