...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/style-login-signin-mvc.css">
</head>
<body>
    <header>
        <div>
            <a href="views/home/signin-admin.php" style="text-decoration: none;">
    ...
    <section>
        ...
        <article>
            ...
            <div class="menu_login">
                ...
                <div class='img-icon'>
                    <img src="../../public/img/surabaya-java.png" alt="">
                </div>
            </form>
                ...
                <?php 
                    if (isset($_POST['submit'])) {
                        ...
                        $cek = mysqli_query($conn, "SELECT * FROM penumpang WHERE nama = '".$nama."' AND password = '".$pass."'");
                        
                        if(mysqli_num_rows($cek) > 0){
                            $d = mysqli_fetch_object($cek);
                            $_SESSION['status_login'] = true;
                            $_SESSION['a_global'] = $d;
                            $_SESSION['id'] = $d->id_penumpang;
                            echo '<script>window.location="index-penumpang.php"</script>';
                        }else{
